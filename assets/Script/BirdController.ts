import { _decorator, Canvas, Component, Node, Vec3, math } from "cc";
...
export class BirdController extends Component {
  private birdSpeed: number = math.randomRangeInt(300, 450);
  private currentDirection: BirdDirection = BirdDirection.Left;
  private directionChangeDelay: number = 0.7;
  ...
  public Initialized(parent: Node): void {
    ...
    this.node.setPosition(
      math.randomRangeInt(-450, 100),
      math.randomRangeInt(-200, -50),
      0
    );
  }
